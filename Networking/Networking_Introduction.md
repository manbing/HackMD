...
* **Firewalls:** Firewalls (like those from Checkpoint or Juniper) often track "sessions" as a "two-way data flow" or "bidirectional flow" that includes multiple underlying connection packets.# Networking Introduction
###### tags: `Networking`
